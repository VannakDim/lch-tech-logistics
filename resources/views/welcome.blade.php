...
<head>
    ...
    <title>{{ config('app.name', 'Vannak Dim') }}</title>
...
<body
    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                class="text-[16px] leading-[20px] flex-1 p-6 pb-12 lg:p-10 bg-white dark:bg-[#161615] dark:text-[#EDEDEC] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] rounded-bl-lg rounded-br-lg lg:rounded-tl-lg lg:rounded-br-none">
                <h1 class="mb-1 font-medium">សូមស្វាគមន៍មកកាន់ការិយាល័យភស្តុភា ហិរញ្ញវត្ថុ</h1>
                <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                    ប្រព័ន្ធគ្រប់គ្រងទិន្នន័យដែលងាយស្រួលក្នុងការតាមដានព័ត៌មានពីឃ្លាំង<br>រាល់ប្រតិបត្តការត្រូវបានរក្សាទុកយ៉ាងសុវត្ថិភាព
                </p>
            ...
            <div
                ...
                {{-- Laravel Logo --}}
                <img src="{{ asset('storage/logistic-img.png') }}" alt="Logistic image"
